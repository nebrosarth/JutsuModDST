local assets =
{
	Asset("ANIM", "anim/headband_leaf.zip"),
...
local function commonfn(anim, atlas)
	...
	minimap:SetIcon("headband_leaf.tex")
...
local function headband_leaf()
    local inst = commonfn("headband_leaf", "headband_leaf")
	
    return inst
end

return Prefab("headband_leaf", headband_leaf, assets)
