...
{ 
	...
	DESCRIBE = "Revive every dead player.",
...
{ 
	...
	DESCRIBE = "Defend yourself from attacks by covering yourself in ice for a short period of time.",
...
{ 
	...
	DESCRIBE = "Only Requires Chakra When Crafting, useful when low on Chakra.",
	USE = "Rasengan!",
...
{ 
	...
	DESCRIBE = "Puts everything to sleep for a short period of time.",
...
TUNING.STRENGTHOFA100 =
{
	...
	DESCRIBE = "Removes a small amount of Maximum Health Penalty.",
	USE = "Reverse Seal!"
}
...
TUNING.CREATIONREBIRTH =
{
	...
	DESCRIBE = "Heals you to full at a cost of a small Max Health Penalty.",
...
TUNING.CREATIONREBIRTH100 =
{
	...
	DESCRIBE = "Toggle over time health regeneration for the cost of chakra.",
...
TUNING.FLYINGRAIJIN =
{
	...
	DESCRIBE = "Travel to Flying Thunder Lord Kunais that you have placed in the world.",
...
TUNING.MULTIMUDWALL =
{
	...
	DESCRIBE = "Summon 4 Mud Walls that block anything from entering unless they break the walls.",
...
TUNING.WATERGUN =
{
	...
	DESCRIBE = "Does Extra Damage to burning targets, has a small AoE and makes targets wet ;).",
...
TUNING.EXPANSION =
{
	...
	DESCRIBE = "Increase your Size and Strength!",
	USE = "Expansion Jutsu!", 
...
TUNING.SUPEREXPANSION =
{
	...
	DESCRIBE = "Increase your Size and Strength EVEN MORE!!",
...
TUNING.DEEPFORESTEMERGENCE =
{
	...
	DESCRIBE = "Increases growth speed of nearby plants and crops.",
...
TUNING.BUBBLE =
{
	...
	DESCRIBE = "Creates a small amount of explosive bubbles that explode on contact with objects or after a period of time.",
...
TUNING.SHADOWCLONE =
{
	...
	DESCRIBE = "Creates a copy of the user which has max health of 50% of user, and max chakra split between clones, starting at 50.",
