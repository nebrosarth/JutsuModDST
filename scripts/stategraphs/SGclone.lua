...
local function DoHurtSound(inst)
    ...
    elseif not inst:HasTag("mime") then
        inst.SoundEmitter:PlaySound((inst.talker_path_override or "dontstarve/characters/")..(inst.soundsname or GetBB(inst)) .."/hurt")
    end
end
...
local function DoYawnSound(inst)
    ...
    elseif not inst:HasTag("mime") then
        inst.SoundEmitter:PlaySound((inst.talker_path_override or "dontstarve/characters/")..(inst.soundsname or GetBB(inst)).."/yawn")
    end
end
...
local function DoTalkSound(inst)
    if inst.talksoundoverride ~= nil then
        ...
        return true
    elseif not inst:HasTag("mime") then
        inst.SoundEmitter:PlaySound((inst.talker_path_override or "dontstarve/characters/")..(inst.soundsname or GetBB(inst)).."/talk_LP", "talk")
        return true
    end
end
        ...
        onenter = function(inst)
            ...
            if inst.components.rider ~= nil and inst.components.rider:IsRiding() then
                ...
                if not inst:HasTag("mime") then
                    inst.SoundEmitter:PlaySound((inst.talker_path_override or "dontstarve/characters/")..(inst.soundsname or GetBB(inst)).."/death_voice")
                end
    ...
    State{
        ...
        onenter = function(inst, data)
            ...
            elseif data.sound ~= false then
                inst.SoundEmitter:PlaySound((inst.talker_path_override or "dontstarve/characters/")..(inst.soundsname or GetBB(inst))..(data.soundoverride or "/emote"), "emotesound")
            end
...
return StateGraph("clone", states, events, "idle", actionhandlers)
