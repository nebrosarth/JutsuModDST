...
local function onbecamehuman(inst)
	...
	inst.components.locomotor:SetExternalSpeedMultiplier(inst, "madara_speed_mod", 1)
end

local function onbecameghost(inst)
	-- Remove speed modifier when becoming a ghost
   inst.components.locomotor:RemoveExternalSpeedMultiplier(inst, "madara_speed_mod")
end
...
return MakePlayerCharacter("madara", prefabs, assets, common_postinit, master_postinit, start_inv)
